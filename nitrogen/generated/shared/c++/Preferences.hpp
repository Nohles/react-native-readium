...
namespace margelo::nitro::readium {
  ...
  public:
    ...
    std::optional<std::string> linkColor     SWIFT_PRIVATE;
    ...
    std::optional<std::string> comicScaleType     SWIFT_PRIVATE;
    ...
    std::optional<double> comicScrollAmountPercent     SWIFT_PRIVATE;
    std::optional<double> comicImagePreloadAmount     SWIFT_PRIVATE;

  public:
    Preferences() = default;
    explicit Preferences(std::optional<std::string> backgroundColor, std::optional<std::string> columnCount, std::optional<std::string> fit, std::optional<std::string> fontFamily, std::optional<double> fontSize, std::optional<double> fontWeight, std::optional<bool> hyphens, std::optional<std::string> imageFilter, std::optional<std::string> language, std::optional<double> letterSpacing, std::optional<bool> ligatures, std::optional<std::string> linkColor, std::optional<double> lineHeight, std::optional<double> pageMargins, std::optional<double> paragraphIndent, std::optional<double> paragraphSpacing, std::optional<bool> publisherStyles, std::optional<std::string> readingProgression, std::optional<bool> scroll, std::optional<std::string> spread, std::optional<std::string> textAlign, std::optional<std::string> textColor, std::optional<bool> textNormalization, std::optional<std::string> theme, std::optional<double> typeScale, std::optional<bool> verticalText, std::optional<double> wordSpacing, std::optional<bool> merging, std::optional<std::string> comicReadingMode, std::optional<std::string> comicScaleType, std::optional<bool> comicStretchSmallPages, std::optional<bool> comicWidthLimitEnabled, std::optional<double> comicWidthLimitPercent, std::optional<double> comicScrollAmountPercent, std::optional<double> comicImagePreloadAmount): backgroundColor(backgroundColor), columnCount(columnCount), fit(fit), fontFamily(fontFamily), fontSize(fontSize), fontWeight(fontWeight), hyphens(hyphens), imageFilter(imageFilter), language(language), letterSpacing(letterSpacing), ligatures(ligatures), linkColor(linkColor), lineHeight(lineHeight), pageMargins(pageMargins), paragraphIndent(paragraphIndent), paragraphSpacing(paragraphSpacing), publisherStyles(publisherStyles), readingProgression(readingProgression), scroll(scroll), spread(spread), textAlign(textAlign), textColor(textColor), textNormalization(textNormalization), theme(theme), typeScale(typeScale), verticalText(verticalText), wordSpacing(wordSpacing), merging(merging), comicReadingMode(comicReadingMode), comicScaleType(comicScaleType), comicStretchSmallPages(comicStretchSmallPages), comicWidthLimitEnabled(comicWidthLimitEnabled), comicWidthLimitPercent(comicWidthLimitPercent), comicScrollAmountPercent(comicScrollAmountPercent), comicImagePreloadAmount(comicImagePreloadAmount) {}
  ...
  struct JSIConverter<margelo::nitro::readium::Preferences> final {
    static inline margelo::nitro::readium::Preferences fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::readium::Preferences(
        ...
        JSIConverter<std::optional<std::string>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "linkColor"))),
        ...
        JSIConverter<std::optional<std::string>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "comicScaleType"))),
        ...
        JSIConverter<std::optional<double>>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "comicScrollAmountPercent"))),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::readium::Preferences& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "linkColor"), JSIConverter<std::optional<std::string>>::toJSI(runtime, arg.linkColor));
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "comicScaleType"), JSIConverter<std::optional<std::string>>::toJSI(runtime, arg.comicScaleType));
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "comicScrollAmountPercent"), JSIConverter<std::optional<double>>::toJSI(runtime, arg.comicScrollAmountPercent));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<std::string>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "linkColor")))) return false;
      ...
      if (!JSIConverter<std::optional<std::string>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "comicScaleType")))) return false;
      ...
      if (!JSIConverter<std::optional<double>>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "comicScrollAmountPercent")))) return false;
