...
open class HybridReadiumViewSpec_cxx {
  ...
  // Properties
  public final var reopenActiveAudiobook: bridge.std__optional_bool_ {
    @inline(__always)
    get {
      return { () -> bridge.std__optional_bool_ in
        if let __unwrappedValue = self.__implementation.reopenActiveAudiobook {
    ...
    @inline(__always)
    set {
      self.__implementation.reopenActiveAudiobook = { () -> Bool? in
